...
export default function Packages() {
  return (
    ...
    >
      ...
      <div className="absolute right-0 bottom-0 h-80 w-80 rounded-full bg-cyan-300/8 blur-[130px]" />
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="text-4xl font-semibold tracking-tight text-white md:text-5xl">
            Choose Your{" "}
            <span className="text-cyan-300">Growth System</span>
          </h2>
          ...
          {packages.map((plan) => (
            <div
              ...
              className={`group relative overflow-hidden rounded-[2rem] border p-7 backdrop-blur-xl transition duration-500 hover:-translate-y-1 ${
                plan.featured
                  ? "lg:-translate-y-4 border-cyan-300/45 bg-cyan-300/[0.08] shadow-[0_0_65px_rgba(34,211,238,0.18)]"
                  : "border-white/10 bg-white/[0.035] hover:border-cyan-300/30 hover:bg-cyan-300/[0.045]"
              }`}
            >
              <div className="absolute right-0 top-0 h-40 w-40 bg-cyan-300/10 blur-[75px] opacity-0 transition duration-500 group-hover:opacity-100" />
