...
export default function Pipeline() {
  return (
    ...
    >
      <div className="absolute right-0 top-20 h-80 w-80 rounded-full bg-cyan-400/10 blur-[130px]" />
      <div className="absolute left-0 bottom-0 h-72 w-72 rounded-full bg-cyan-400/8 blur-[130px]" />
      <div className="absolute inset-0 bg-[linear-gradient(rgba(34,211,238,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(34,211,238,0.03)_1px,transparent_1px)] bg-[size:72px_72px]" />
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="relative mt-16 rounded-[2.5rem] border border-cyan-300/15 bg-white/[0.025] p-6 shadow-[inset_0_0_35px_rgba(34,211,238,0.04)] backdrop-blur-xl md:p-8">
          <div className="absolute left-8 right-8 top-1/2 hidden h-[3px] -translate-y-1/2 rounded-full bg-cyan-300/25 shadow-[0_0_25px_rgba(34,211,238,0.45)] xl:block" />
          ...
          <div className="relative grid gap-5 md:grid-cols-2 xl:grid-cols-5">
            {stages.map((stage, index) => (
              ...
              >
                ...
                <div className="absolute left-1/2 top-0 h-24 w-24 -translate-x-1/2 rounded-full bg-cyan-300/10 blur-[50px] opacity-0 transition duration-500 group-hover:opacity-100" />
                ...
                {index !== stages.length - 1 && (
                  <div className="absolute -right-3 top-1/2 z-20 hidden h-6 w-6 -translate-y-1/2 items-center justify-center rounded-full border border-cyan-300/40 bg-[#03060b] shadow-[0_0_25px_rgba(34,211,238,0.75)] xl:flex">
