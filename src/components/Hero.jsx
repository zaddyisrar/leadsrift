...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-20 lg:grid-cols-[1fr_0.95fr]">
        {/* Left */}
        <div>
          ...
          <h1 className="max-w-5xl text-5xl font-semibold leading-[0.92] tracking-tight text-white md:text-7xl lg:text-[82px]">
          ...
          <p className="mt-7 max-w-2xl text-base leading-8 text-gray-300 md:text-lg">
            ...
            cold calling, email, LinkedIn, lead qualification, and follow-up
            to help service businesses fill their calendar with real prospects.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-sm text-gray-300">
            {[
              ...
              <span
                key={item}
                className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 transition hover:border-cyan-300/25"
              >
                {item}
              </span>
            ))}
        ...
        <div className="relative">
          ...
          <div className="relative rounded-[2.5rem] border border-cyan-300/25 bg-cyan-300/[0.07] p-4 shadow-[0_0_50px_rgba(34,211,238,0.16)] backdrop-blur-2xl transition hover:-translate-y-1">
            <div className="rounded-[2rem] border border-white/10 bg-[#07111f]/95 p-6 md:p-7">
              ...
              <div className="space-y-4">
                {pipelineSteps.map((item, index) => (
                  <div
                    key={item}
                    className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/[0.035] p-4 transition hover:border-cyan-300/20"
                  >
