...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-[#03060b] text-white">
      {/* ABOUT HERO */}
      <section className="relative overflow-hidden border-b border-cyan-500/10 px-6 py-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-20 text-center">
            ...
            <h2 className="text-4xl font-semibold md:text-6xl">
              The People Behind <span className="text-cyan-300">LeadsRift</span>
            </h2>
  ...
  <Image
    ...
    fill
    priority
    className="object-contain object-top p-5"
  />
